...
class AdminApi {
  ...
  Future<Response<AdminUserResponse>> adminActivateUser({ 
    ...
    final _path = r'/api/v1/admin/users/{userId}/activate'.replaceAll('{' r'userId' '}', encodeQueryParameter(_serializers, userId, const FullType(String)).toString());
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [AdminGroupResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AdminGroupResponse>> adminGetGroup({ 
    ...
    final _path = r'/api/v1/admin/groups/{groupId}'.replaceAll('{' r'groupId' '}', encodeQueryParameter(_serializers, groupId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    AdminGroupResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(AdminGroupResponse),
      ) as AdminGroupResponse;
  ...
  Future<Response<AdminUserResponse>> adminGetUser({ 
    ...
    final _path = r'/api/v1/admin/users/{userId}'.replaceAll('{' r'userId' '}', encodeQueryParameter(_serializers, userId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AuditLogPageResponse>> adminListAuditLogs({ 
    int? limit = 50,
    String? cursor,
    String? action,
    String? targetType,
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (actorUserId != null) r'actorUserId': encodeQueryParameter(_serializers, actorUserId, const FullType(String)),
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [AdminGroupMemberPageResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AdminGroupMemberPageResponse>> adminListGroupMembers({ 
    required String groupId,
    int? limit = 30,
    String? cursor,
    String? search,
    ...
    final _path = r'/api/v1/admin/groups/{groupId}/members'.replaceAll('{' r'groupId' '}', encodeQueryParameter(_serializers, groupId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    AdminGroupMemberPageResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(AdminGroupMemberPageResponse),
      ) as AdminGroupMemberPageResponse;
    ...
    return Response<AdminGroupMemberPageResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [AdminGroupPageResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AdminGroupPageResponse>> adminListGroups({ 
    int? limit = 30,
    String? status,
    String? cursor,
    String? search,
    ...
    final _path = r'/api/v1/admin/groups';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    AdminGroupPageResponse? _responseData;
    ...
    return Response<AdminGroupPageResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [JobRunPageResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JobRunPageResponse>> adminListJobRuns({ 
    int? limit = 30,
    String? cursor,
    String? status,
    CancelToken? cancelToken,
    ...
    final _path = r'/api/v1/admin/jobs/runs';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    JobRunPageResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(JobRunPageResponse),
      ) as JobRunPageResponse;
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [AdminUserPageResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AdminUserPageResponse>> adminListUsers({ 
    int? limit = 30,
    String? status,
    String? role,
    String? cursor,
    ...
    AdminUserPageResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(AdminUserPageResponse),
      ) as AdminUserPageResponse;
    ...
    return Response<AdminUserPageResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [AdminOverviewResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AdminOverviewResponse>> adminOverview({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    AdminOverviewResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(AdminOverviewResponse),
    ...
    return Response<AdminOverviewResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<SuccessResponse>> adminRevokeUserDevice({ 
    required String userId,
    ...
    final _path = r'/api/v1/admin/users/{userId}/devices/{sessionId}'.replaceAll('{' r'userId' '}', encodeQueryParameter(_serializers, userId, const FullType(String)).toString()).replaceAll('{' r'sessionId' '}', encodeQueryParameter(_serializers, sessionId, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [JobRunResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JobRunResponse>> adminRunCleanup({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1/admin/jobs/cleanup/run';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    JobRunResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(JobRunResponse),
      ) as JobRunResponse;
  ...
  /// Returns a [Future] containing a [Response] with a [AdminGroupResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AdminGroupResponse>> adminSetGroupPolicy({ 
    required String groupId,
    required SetGroupPolicyDto setGroupPolicyDto,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1/admin/groups/{groupId}/policy'.replaceAll('{' r'groupId' '}', encodeQueryParameter(_serializers, groupId, const FullType(String)).toString());
    final _options = Options(
      method: r'PATCH',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(SetGroupPolicyDto);
      _bodyData = _serializers.serialize(setGroupPolicyDto, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [AdminUserResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AdminUserResponse>> adminSuspendUser({ 
    required String userId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/admin/users/{userId}/suspend'.replaceAll('{' r'userId' '}', encodeQueryParameter(_serializers, userId, const FullType(String)).toString());
    final _options = Options(
      method: r'PATCH',
      headers: <String, dynamic>{
        ...?headers,
