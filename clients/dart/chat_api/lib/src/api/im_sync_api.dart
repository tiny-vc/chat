...
class ImSyncApi {
  ...
  const ImSyncApi(this._dio, this._serializers);
  ...
  Future<Response<BuiltMap<String, JsonObject>>> imSyncMarkRead({ 
    ...
    final _path = r'/api/v1/im/conversations/read';
    ...
    try {
      const _type = FullType(MarkImReadDto);
      _bodyData = _serializers.serialize(markImReadDto, specifiedType: _type);
  ...
  Future<Response<BuiltMap<String, JsonObject>>> imSyncReceipts({ 
    ...
    final _path = r'/api/v1/im/messages/receipts';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(SyncImReceiptsDto);
      _bodyData = _serializers.serialize(syncImReceiptsDto, specifiedType: _type);
  ...
  Future<Response<BuiltMap<String, JsonObject>>> imSyncRevokeMessage({ 
    ...
    final _path = r'/api/v1/im/messages/revoke';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(RevokeImMessageDto);
      _bodyData = _serializers.serialize(revokeImMessageDto, specifiedType: _type);
  ...
  Future<Response<BuiltMap<String, JsonObject>>> imSyncSyncConversations({ 
    ...
    final _path = r'/api/v1/im/conversations/sync';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(SyncImConversationsDto);
      _bodyData = _serializers.serialize(syncImConversationsDto, specifiedType: _type);
  ...
  Future<Response<BuiltMap<String, JsonObject>>> imSyncSyncMessages({ 
    ...
    final _path = r'/api/v1/im/messages/sync';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(SyncImChannelMessagesDto);
      _bodyData = _serializers.serialize(syncImChannelMessagesDto, specifiedType: _type);
