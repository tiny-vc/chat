...
class LivekitWebhookApi {

  final Dio _dio;

  final Serializers _serializers;

  const LivekitWebhookApi(this._dio, this._serializers);
  ...
  Future<Response<BuiltMap<String, JsonObject>>> livekitWebhookReceive({ 
    ...
    final _path = r'/api/v1/webhooks/livekit';
