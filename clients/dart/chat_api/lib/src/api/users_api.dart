...
class UsersApi {
  ...
  Future<Response<UserResponse>> usersGetById({ 
    ...
    final _path = r'/api/v1/users/{userId}'.replaceAll('{' r'userId' '}', encodeQueryParameter(_serializers, userId, const FullType(String)).toString());
  ...
  /// Returns a [Future] containing a [Response] with a [UserResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserResponse>> usersGetMe({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// Returns a [Future] containing a [Response] with a [UserResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserResponse>> usersRemoveAvatar({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  Future<Response<SuccessResponse>> usersReport({ 
    ...
    final _path = r'/api/v1/users/{userId}/report'.replaceAll('{' r'userId' '}', encodeQueryParameter(_serializers, userId, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(ReportUserDto);
      _bodyData = _serializers.serialize(reportUserDto, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [UserResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserResponse>> usersSetAvatar({ 
    ...
    try {
      const _type = FullType(SetAvatarDto);
      _bodyData = _serializers.serialize(setAvatarDto, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [UserResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserResponse>> usersUpdateMe({ 
    ...
    try {
      ...
      _bodyData = _serializers.serialize(updateProfileDto, specifiedType: _type);
